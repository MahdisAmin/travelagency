...
const PassengerForm = ({
  ...
  return (
    <div>
      <form
        className="grid grid-cols-12 gap-4 p-10 max-w-[800px] md:bg-white"
      ...
      >
        ...
        <div className="col-span-12 md:col-span-4 border rounded-lg p-2 border-gray-600 relative">
          <select
            ...
            {...register("gender", {
              required: "یکی از گزینه هارا انتخاب کنید",
            })}
          >
        ...
        <div className="flex flex-col  md:flex-row  md:max-w-[500px] w-[285px] justify-center items-center mx-5">
          <button
            type="submit"
